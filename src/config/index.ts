...
const badge = {
  ...
  variant: {
    solid: 'bg-orange-500 dark:bg-orange-400 text-white dark:text-gray-900',
    outline: 'text-orange-500 dark:text-orange-400 ring-1 ring-inset ring-orange-500 dark:ring-orange-400',
    soft: 'bg-orange-50 dark:bg-orange-400 dark:bg-opacity-10 text-orange-500 dark:text-orange-400',
    subtle: 'bg-orange-50 dark:bg-orange-400 dark:bg-opacity-10 text-orange-500 dark:text-orange-400 ring-1 ring-inset ring-orange-500 dark:ring-orange-400 ring-opacity-25 dark:ring-opacity-25'
  },
  default: {
    size: 'sm',
    variant: 'solid',
...
const button = {
  ...
  variant: {
    solid: 'shadow-sm text-white dark:text-gray-900 bg-orange-500 hover:bg-orange-600 disabled:bg-orange-500 dark:bg-orange-400 dark:hover:bg-orange-500 dark:disabled:bg-orange-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500 dark:focus-visible:outline-orange-400',
    outline: 'ring-1 ring-inset ring-current text-orange-500 dark:text-orange-400 hover:bg-orange-50 disabled:bg-transparent dark:hover:bg-orange-950 dark:disabled:bg-transparent focus-visible:ring-2 focus-visible:ring-orange-500 dark:focus-visible:ring-orange-400',
    ...
    ghost: 'text-orange-500 dark:text-orange-400 hover:bg-orange-50 disabled:bg-transparent dark:hover:bg-orange-950 dark:disabled:bg-transparent focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-orange-500 dark:focus-visible:ring-orange-400',
...
const input = {
  ...
  variant: {
    outline: 'shadow-sm bg-transparent text-gray-900 dark:text-white ring-1 ring-inset ring-orange-500 dark:ring-orange-400 focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-400',
